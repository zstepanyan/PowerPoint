...
// CreateSlideAction - creates a new slide
...
// DeleteSlideAction - deletes a slide
...
// AddTextAction - adds text to a slide (fails if text already exists)
...
// EditTextAction - modifies existing text on a slide
...
// ClearTextAction - removes text from a slide
